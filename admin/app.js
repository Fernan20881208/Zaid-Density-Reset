...
const configured = !Object.values(config).some((value) => String(value).includes("YOUR_"));
...
if (!configured) {
  showMessage(loginError, "Configura admin/config.js usando config.example.js antes de usar el panel.");
